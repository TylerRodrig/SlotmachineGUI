...
class Slots(EasyFrame):
	...
	def __init__(self):
		...
		EasyFrame.__init__(self, title = "Slot Machine", resizable = False, background = "lightslategrey")

		self.addLabel(text = "Slot Machine", row = 0, column = 0, columnspan = 3, sticky = "NSEW", background = "lightslategrey").config(font = ("Georgia", 30 ))
